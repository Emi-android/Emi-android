package com.lzh.citytime.widget;
...
public class ScrollerNumberPicker extends View {
    ...
    public void setSelectedFont(int size) {
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            // 绘制内容
            float dLeft = x + controlWidth / 2 - textRect.width() / 2;
            if (gravity == Gravity.LEFT) {
                dLeft = x + pixOfDip(20) - textRect.width() / 2;
            } else if (gravity == Gravity.RIGHT) {
                dLeft = controlWidth - pixOfDip(20) - textRect.width() / 2;
            }
            canvas.drawText(itemText, dLeft, y + move + unitHeight / 2 + textRect.height() / 2,
                    textPaint);
